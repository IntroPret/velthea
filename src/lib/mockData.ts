...
export const hampers: Hamper[] = [
  {
    ...
    defaultItems: [
      { id: "choc", name: "Artisan Chocolate", price: 8 },
      { id: "candle", name: "Soy Candle", price: 12 },
    ],
  },
  {
    id: "premium",
    ...
    defaultItems: [
      { id: "skincare", name: "Skincare Mini", price: 18 },
      { id: "tea", name: "Herbal Tea", price: 9 },
    ],
  },
  {
    id: "romantic",
    ...
    defaultItems: [
      { id: "rose", name: "Dried Rose Bundle", price: 10 },
      { id: "truffles", name: "Cocoa Truffles", price: 12 },
    ],
  },
];
...
export const itemCatalog: HamperItem[] = [
  ...
  { id: "rose", name: "Dried Rose Bundle", price: 10 },
  { id: "truffles", name: "Cocoa Truffles", price: 12 },
  { id: "journal", name: "Linen Journal", price: 14 },
  { id: "mug", name: "Ceramic Mug", price: 16 },
];
