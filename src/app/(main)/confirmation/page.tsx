...
export default function ConfirmationPage() {
  ...
  const feedbackFormUrl = "https://docs.google.com/forms/d/e/1FAIpQLSecoOpZOdVakfkJr_m_sDth1Y6JidWMz8AgEBYRP3cHle04SQ/viewform?usp=dialog "
  return (
    <div>
      <main className="mx-auto max-w-3xl px-6 py-16 text-center">
        <h1 className="heading-hero text-4xl mb-4">Your gesture of grace is on its way.</h1>
        <p className="text-[color:var(--color-muted)] mb-4">Thank you for trusting Velthéa.</p>
        <p className="text-sm text-[color:var(--color-muted)] mb-8">
          This demo flow does not create a real order. We would love your feedback below.
        </p>
